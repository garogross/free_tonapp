              ...
              {!acceleratorsStatus ? (
                <>
                  ...
                  <div className={styles.miningSpeedInfoModal__infoBlock}>
                    <span
                      className={styles.miningSpeedInfoModal__infoBlockText}
                    >
                  ...
                  <SecondaryBtn onClick={writeLinkInClipboard}>
                    ...
                    <CopyIcon
                      className={styles.miningSpeedInfoModal__copyIcon}
                    />
                  </SecondaryBtn>
                </>
              ) : modalPage === "store" ? (
                <>
                  <div
                    className={
                      styles.miningSpeedInfoModal__acceleratorsContainer
                    }
                  >
                    <div
                      className={clsx(
                  ...
                  >
                    <div
                      className={styles.miningSpeedInfoModal__rentPeriodTitle}
                    >
                  ...
                  <div
                    className={
                      styles.miningSpeedInfoModal__totalProfitContainer
                    }
                  >
                    <div
                  ...
                  <div
                    className={styles.miningSpeedInfoModal__counterContainer}
                  >
                    <div
                      className={
                        styles.miningSpeedInfoModal__counterButtonMinus
                      }
                  ...
                  >
                    <div
                      className={
                        styles.miningSpeedInfoModal__totalRentPriceTitle
                      }
                    >
